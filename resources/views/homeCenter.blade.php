                        ...
                        <div class="col-lg-12">
                          <div class="ibox float-e-margins">
                              ...
                              <div class="ibox-content">
                                ...
                                <tbody>
                                <tr ng-repeat="problem in problems | filter:tookFilter | filter: search | filter:colourFilter" problem-show-directive problem="problem" user="{{Auth::id()}}" ng-cloak foo-repeat-done>
                                    <td><% $index+1 %></td>
                                    ...
                                    <td>
                                      <div ng-repeat="offer in problem.offers">
                                        <div class="row" style="width:100%">
                                            ...
                                            <div class="col-md-4" my-offer offer="offer">
                                               <p>
                                                 <%  offer.persFrom.name %> <%  offer.persFrom.lastName %> <%  offer.isMine %>
                                               </p>
                                             </div>
