                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div  class="col-md-2" style="padding:10px 20px">
                                        <a href="index.html"><img id="logo_img" src="images/logo_cool_green.png" alt="Rukhell"></a>
                                </div>
                                        ...
                                        <div class="container-fluid">
                                            ...
                                            <div class="collapse navbar-collapse" id="navbar-collapse-1">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-sm-6 col-md-3">
                                                                                ...
                                                                                <ul class="menu">
                                                                                    ...
                                                                                    <li class="active"><a href="index-education.html"><i class="fa fa-graduation-cap pr-10"></i>Education <span class="badge">v1.1</span></a></li>
                                                ...
                                                <div class="header-dropdown-buttons">
                                                    <a href="mailto:theproject@info.com" class="btn btn-sm hidden-xs btn-default">Submit problem </a>
                                                    <a href="mailto:theproject@info.com" class="btn btn-lg visible-xs btn-block btn-default">Submit problem </a>
                                                </div>
                                                <!-- header buttons end-->
                    ...
                    <div class="slider-revolution-5-container">
                        <div id="slider-banner-fullwidth" class="slider-banner-fullwidth rev_slider" data-version="5.0">
                            <ul class="slides">
                                ...
                                <!-- main image -->
                                <img src="images/education-slider-slide-1.jpg" alt="slidebg1" data-bgposition="center top"  data-bgrepeat="no-repeat" data-bgfit="cover"  class="rev-slidebg">
                                ...
                                <!-- main image -->
                                <img src="images/education-slider-slide-2.jpg" alt="slidebg2" data-bgposition="center top"  data-bgrepeat="no-repeat" data-bgfit="cover" class="rev-slidebg">
